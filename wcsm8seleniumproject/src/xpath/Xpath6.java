...
public class Xpath6 {
     ...
     //xpath using independent and dependant method
	...
	public static void main(String[] args) throws InterruptedException {
		...
		String priceoffirstsugestion = driver.findElement(By.xpath("(//div[@class='_4rR01T']/ancestor::div[@class='_3pLy-c row']/descendant::div[@class='_30jeq3 _1_WHN1'])[1]")).getText();
		   System.out.println(priceoffirstsugestion);
